...
var vectorSource = new VectorSource({
    ...
    url: function(extent) {
        return 'https://mymapnik.rudzick.it/geoserver/wfs?service=WFS&' +
            'version=1.1.0&request=GetFeature&typename=Kleingartenparzellen:planet_osm_polygon:Offene_Gaerten&' +
...
var map = new Map({
  ...
  layers: [
    new TileLayer({
      extent: mapExtent,
      source: new XYZ({
        attributions: 'Offene Gärten am 12.06.2022<br/>' +'© ' +
