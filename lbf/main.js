...
var center = [787273.73, 6568990.56]
var rotation = 0;
var marker = 0;
...
var LBFBaumnummernLayer = new TileLayer({
    extent: mapExtent,
    opacity: 1.0,
    source: new XYZ({
 	url: 'https://mymapnik.rudzick.it/MeinMapnikWMS/tiles/lbf_baumnummern_hq/webmercator_hq/{z}/{x}/{y}.png?origin=nw',
  ...
  target: 'map',
	...
	new TileLayer({
		...
		attributions: '<p style="text-align:left;font-family:verdana;"> © ' +
		    ...
		    '<a href="https://mymapnik.rudzick.it/LBF/about/">Über diese Karte</a></p>', 
